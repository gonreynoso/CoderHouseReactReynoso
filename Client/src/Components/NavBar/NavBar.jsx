...
import { ChevronDown, Lock, Activity, Flash, Server, TagUser, Scale } from "../NextUI/Icons/Icons/Icons";
    ...
    <Navbar isBordered>
      <NavbarContent justify="start">
        ...
        <NavbarContent className="hidden sm:flex gap-3">
          ...
          <NavbarItem>
            <NavLink to="/category/camionetas">
              <Link color="foreground">Camionetas</Link>
            </NavLink>
          </NavbarItem>
          <NavbarItem>
            <NavLink to="/">
